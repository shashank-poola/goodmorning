...
/**
 * THE swap point. When VITE_USE_API=true, calendar, email, news, GitHub,
 * todos, tweets, recap, and LinkedIn come from the backend; all other widgets stay on mock until their subsystems ship.
